...
clim <- read.table(here("~/Desktop/232 Modeling/Almond_Yield_HW/clim.txt"), header = TRUE, sep = "", strip.white = TRUE)
...
ya <- yield_results$yield_anomaly[yield_results$year == all_years]
